...
public class LinkedInActionTest {
	...
	@Test
	public void test() {
		SignUpWithLinkedInAction tester = new SignUpWithLinkedInAction();
	    ...
	    SignUpWithLinkedInCallbackAction tester2 = new SignUpWithLinkedInCallbackAction();
